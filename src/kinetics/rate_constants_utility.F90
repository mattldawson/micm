...
subroutine k_rate_constant(k_rate_constants, number_density_air__num_m3, temperature, pressure, sad, &
                           aerosol_diameter, H2O_number_density__num_m3, O2_number_density__num_m3)
    ...
    real(KIND=r8),           intent(in)  :: number_density_air__num_m3 ! P/kT molecules/m3 
    real(KIND=r8),           intent(in)  :: H2O_number_density__num_m3 
    real(KIND=r8),           intent(in)  :: O2_number_density__num_m3 
    ...
    environmental_state%number_density_air__num_m3 = number_density_air__num_m3 

    environmental_state%H2O_number_density__num_m3 = H2O_number_density__num_m3 

    environmental_state%O2_number_density__num_m3 = O2_number_density__num_m3 
